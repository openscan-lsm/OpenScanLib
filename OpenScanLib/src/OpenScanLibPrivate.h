...
OSc_RichError *OScInternal_Error_RetrieveFromDevice(OSc_Device *device,
                                                    int32_t code);

OSc_RichError *OScInternal_Error_RetrieveFromSetting(OSc_Setting *setting,
                                                     int32_t code);

OSc_RichError *OScInternal_Error_RetrieveFromModule(OScDev_ModuleImpl *modImpl,
                                                    int32_t code);
...
OSc_RichError *OScInternal_Error_CreateWithCode(const char *domainName,
                                                int32_t code,
                                                const char *message);

OSc_RichError *OScInternal_Error_Wrap(OSc_RichError *cause,
                                      const char *message);

OSc_RichError *OScInternal_Error_WrapWithCode(OSc_RichError *cause,
...
OScDev_RichError *
OScInternal_Error_RegisterCodeDomain(const char *domainName,
...
void OScInternal_Error_Format(OSc_RichError *error, char *buffer,
                              size_t bufsize);

void OScInternal_Error_FormatRecursive(OSc_RichError *error, char *buffer,
                                       size_t bufsize);
...
void OScInternal_Log(OSc_Device *device, OSc_LogLevel level,
                     const char *message);

static inline void OScInternal_LogDebug(OSc_Device *device,
                                        const char *message) {
    OScInternal_Log(device, OSc_LogLevel_Debug, message);
}

static inline void OScInternal_LogInfo(OSc_Device *device,
                                       const char *message) {
    OScInternal_Log(device, OSc_LogLevel_Info, message);
}

static inline void OScInternal_LogWarning(OSc_Device *device,
                                          const char *message) {
    OScInternal_Log(device, OSc_LogLevel_Warning, message);
}

static inline void OScInternal_LogError(OSc_Device *device,
                                        const char *message) {
...
OScInternal_NumArray_CreateFromNaNTerminated(const double *nanTerminatedArray);
OScInternal_NumArray *
OScInternal_NumArray_Copy(const OScInternal_NumArray *arr);

...
struct OScDev_ModuleImpl
{
	...
	* If true, all errors generated by the device module should be rich errors,
	* and they should be returned by converting to temporary integer codes via
	* OScDev_Error_ReturnAsCode(). All new device modules should set this to true.
	*/

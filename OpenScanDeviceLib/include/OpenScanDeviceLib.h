 ...
 */
#define OScDevInternal_MAKE_VERSION(major, minor)                             \
...
enum {
    ...
    OScDev_ErrorCodeFormat_Hex16 =
        32, ///< 16-bit unsigned integer, hexadecimal
...
struct OScDevInternal_Interface {
    ...
    void (*Log)(OScDev_ModuleImpl *modImpl, OScDev_Device *device,
                OScDev_LogLevel level, const char *message);

    OScDev_RichError *(*Error_RegisterCodeDomain)(
        OScDev_ModuleImpl *modImpl, const char *domainName,
        OScDev_ErrorCodeFormat codeFormat);
    OScDev_Error (*Error_ReturnAsCode)(OScDev_ModuleImpl *modImpl,
                                       OScDev_RichError *error);
    OScDev_RichError *(*Error_Create)(OScDev_ModuleImpl *modImpl,
                                      const char *message);
    OScDev_RichError *(*Error_CreateWithCode)(OScDev_ModuleImpl *modImpl,
                                              const char *domainName,
                                              OScDev_Error code,
                                              const char *message);
    OScDev_RichError *(*Error_Wrap)(OScDev_ModuleImpl *modImpl,
                                    OScDev_RichError *cause,
                                    const char *message);
    OScDev_RichError *(*Error_WrapWithCode)(OScDev_ModuleImpl *modImpl,
                                            OScDev_RichError *cause,
                                            const char *domainName,
                                            int32_t code, const char *message);

    const char *(*Error_GetMessage)(OScDev_ModuleImpl *modImpl,
                                    OScDev_RichError *error);
    const char *(*Error_GetDomain)(OScDev_ModuleImpl *modImpl,
                                   OScDev_RichError *error);
    int32_t (*Error_GetCode)(OScDev_ModuleImpl *modImpl,
                             OScDev_RichError *error);
    OScDev_RichError *(*Error_GetCause)(OScDev_ModuleImpl *modImpl,
                                        OScDev_RichError *error);
    void (*Error_Format)(OScDev_ModuleImpl *modImpl, OScDev_RichError *error,
                         char *buffer, size_t bufsize);
    void (*Error_FormatRecursive)(OScDev_ModuleImpl *modImpl,
                                  OScDev_RichError *error, char *buffer,
                                  size_t bufsize);
    OScDev_RichError *(*Error_AsRichError)(OScDev_ModuleImpl *modImpl,
                                           OScDev_Error code);
    ...
    OScDev_PtrArray *(*PtrArray_CreateFromNullTerminated)(
        OScDev_ModuleImpl *modImpl, void *const *nullTerminatedArray);
    void (*PtrArray_Destroy)(OScDev_ModuleImpl *modImpl,
                             const OScDev_PtrArray *arr);
    void (*PtrArray_Append)(OScDev_ModuleImpl *modImpl, OScDev_PtrArray *arr,
                            void *obj);
    size_t (*PtrArray_Size)(OScDev_ModuleImpl *modImpl,
                            const OScDev_PtrArray *arr);
    bool (*PtrArray_Empty)(OScDev_ModuleImpl *modImpl,
                           const OScDev_PtrArray *arr);
    void *(*PtrArray_At)(OScDev_ModuleImpl *modImpl,
                         const OScDev_PtrArray *arr, size_t index);

    OScDev_NumArray *(*NumArray_Create)(OScDev_ModuleImpl *modImpl);
    OScDev_NumArray *(*NumArray_CreateFromNaNTerminated)(
        OScDev_ModuleImpl *modImpl, const double *nanTerminatedArray);
    void (*NumArray_Destroy)(OScDev_ModuleImpl *modImpl,
                             const OScDev_NumArray *arr);
    void (*NumArray_Append)(OScDev_ModuleImpl *modImpl, OScDev_NumArray *arr,
                            double val);
    size_t (*NumArray_Size)(OScDev_ModuleImpl *modImpl,
                            const OScDev_NumArray *arr);
    bool (*NumArray_Empty)(OScDev_ModuleImpl *modImpl,
                           const OScDev_NumArray *arr);
    double (*NumArray_At)(OScDev_ModuleImpl *modImpl,
                          const OScDev_NumArray *arr, size_t index);

    OScDev_NumRange *(*NumRange_CreateContinuous)(OScDev_ModuleImpl *modImpl,
                                                  double rMin, double rMax);
    OScDev_NumRange *(*NumRange_CreateDiscrete)(OScDev_ModuleImpl *modImpl);
    OScDev_NumRange *(*NumRange_CreateDiscreteFromNaNTerminated)(
        OScDev_ModuleImpl *modImpl, const double *nanTerminatedArray);
    void (*NumRange_Destroy)(OScDev_ModuleImpl *modImpl,
                             const OScDev_NumRange *range);
    void (*NumRange_AppendDiscrete)(OScDev_ModuleImpl *modImpl,
                                    OScDev_NumRange *range, double val);

    OScDev_Error (*Device_Create)(OScDev_ModuleImpl *modImpl,
                                  OScDev_Device **device,
                                  OScDev_DeviceImpl *impl, void *data);
    void *(*Device_GetImplData)(OScDev_ModuleImpl *modImpl,
                                OScDev_Device *device);

    OScDev_Error (*Setting_Create)(OScDev_ModuleImpl *modImpl,
                                   OScDev_Setting **setting, const char *name,
                                   OScDev_ValueType valueType,
                                   OScDev_SettingImpl *impl, void *data);
    void (*Setting_Destroy)(OScDev_ModuleImpl *modImpl,
                            OScDev_Setting *setting);
    void *(*Setting_GetImplData)(OScDev_ModuleImpl *modImpl,
                                 OScDev_Setting *setting);

    // TODO These can return void
    OScDev_Error (*Acquisition_IsClockRequested)(OScDev_ModuleImpl *modImpl,
                                                 OScDev_Acquisition *acq,
                                                 bool *isRequested);
    OScDev_Error (*Acquisition_IsScannerRequested)(OScDev_ModuleImpl *modImpl,
                                                   OScDev_Acquisition *acq,
                                                   bool *isRequested);
    OScDev_Error (*Acquisition_IsDetectorRequested)(OScDev_ModuleImpl *modImpl,
                                                    OScDev_Acquisition *acq,
                                                    bool *isRequested);
    OScDev_Error (*Acquisition_GetClockStartTriggerSource)(
        OScDev_ModuleImpl *modImpl, OScDev_Acquisition *acq,
        OScDev_TriggerSource *startTrigger);
    OScDev_Error (*Acquisition_GetClockSource)(OScDev_ModuleImpl *modImpl,
                                               OScDev_Acquisition *acq,
                                               OScDev_ClockSource *clock);

    uint32_t (*Acquisition_GetNumberOfFrames)(OScDev_ModuleImpl *modImpl,
                                              OScDev_Acquisition *acq);
    double (*Acquisition_GetPixelRate)(OScDev_ModuleImpl *modImpl,
                                       OScDev_Acquisition *acq);
    uint32_t (*Acquisition_GetResolution)(OScDev_ModuleImpl *modImpl,
                                          OScDev_Acquisition *acq);
    double (*Acquisition_GetZoomFactor)(OScDev_ModuleImpl *modImpl,
                                        OScDev_Acquisition *acq);
    void (*Acquisition_GetROI)(OScDev_ModuleImpl *modImpl,
                               OScDev_Acquisition *acq, uint32_t *xOffset,
                               uint32_t *yOffset, uint32_t *width,
                               uint32_t *height);

    bool (*Acquisition_CallFrameCallback)(OScDev_ModuleImpl *modImpl,
                                          OScDev_Acquisition *acq,
...
struct OScDev_ModuleImpl {
    ...
    /*
     * This flag determines how the device module reports errors.
     * If false, the device module uses conventional integer error codes.
     * If true, all errors generated by the device module should be rich
     * errors, and they should be returned by converting to temporary integer
     * codes via OScDev_Error_ReturnAsCode(). All new device modules should set
     * this to true.
     */
...
struct OScDev_DeviceImpl {
     ...
     * are synchronized. When the scanner and detector belong to the same
     * device, the clock can be entirely internal. When the scanner and
     * detector belong to separate devices, typically one or the other device
     * also provides the clock, and the other device receives the clock through
     * a hardware connection (most commonly a TTL line clock, but this need not
     * be the case).
     */
    ...
    OScDev_Error (*MakeSettings)(OScDev_Device *device,
     ...
     * **Required**
     */
    OScDev_Error (*GetPixelRates)(OScDev_Device *device,
     ...
     */
    OScDev_Error (*GetActualPixelRate)(OScDev_Device *device,
     ...
     */
    OScDev_Error (*GetResolutions)(OScDev_Device *device,
     ...
     */
    OScDev_Error (*GetZoomFactors)(OScDev_Device *device,
     ...
     */
    OScDev_Error (*GetRasterWidths)(OScDev_Device *device,
                                    OScDev_NumRange **widths);
     ...
     * will be limited by the scanner resolution.
     */
    OScDev_Error (*GetRasterHeights)(OScDev_Device *device,
                                     OScDev_NumRange **heights);
     ...
     */
    OScDev_Error (*GetNumberOfChannels)(OScDev_Device *device,
                                        uint32_t *nChannels);
     ...
     * **Required** if this device has a detector.
     */
    OScDev_Error (*GetBytesPerSample)(OScDev_Device *device,
     ...
     *
     * If there is no acquisition running and the device is not armed, then
     * this function must succeed with no effect.
     *
    ...
    /**
     * As soon as this function returns, `IsRunning()` must return `false`
...
struct OScDev_SettingImpl {
     ...
     */
    OScDev_Error (*GetNumericConstraintType)(
     ...
     */
    OScDev_Error (*GetInt32Range)(OScDev_Setting *setting, int32_t *min,
                                  int32_t *max);
     ...
     */
    OScDev_Error (*GetInt32DiscreteValues)(OScDev_Setting *setting,
     ...
     * \pre \p setting, \p min, and \p max are guaranteed to be valid pointers.
     */
    OScDev_Error (*GetFloat64Range)(OScDev_Setting *setting, double *min,
                                    double *max);
     ...
     * \return error in case hardware need to be queried and query failed
     */
    OScDev_Error (*GetFloat64DiscreteValues)(OScDev_Setting *setting,
                                             OScDev_NumArray **values);
    ...
    OScDev_Error (*GetEnumNameForValue)(OScDev_Setting *setting,
                                        uint32_t value, char *name);
    OScDev_Error (*GetEnumValueForName)(OScDev_Setting *setting,
...
/// Log a message
OScDev_API void OScDev_Log(OScDev_Device *device, OScDev_LogLevel level,
                           const char *message) {
    OScDevInternal_FunctionTable->Log(&OScDevInternal_TheModuleImpl, device,
                                      level, message);
}
...
OScDev_API void OScDev_Log_Warning(OScDev_Device *device,
                                   const char *message) {
...
OScDev_API OScDev_RichError *
OScDev_Error_RegisterCodeDomain(const char *domainName,
                                OScDev_ErrorCodeFormat codeFormat) {
    return OScDevInternal_FunctionTable->Error_RegisterCodeDomain(
        &OScDevInternal_TheModuleImpl, domainName, codeFormat);
}

OScDev_API OScDev_Error OScDev_Error_ReturnAsCode(OScDev_RichError *error) {
    return OScDevInternal_FunctionTable->Error_ReturnAsCode(
        &OScDevInternal_TheModuleImpl, error);
}

OScDev_API OScDev_RichError *OScDev_Error_Create(const char *message) {
    return OScDevInternal_FunctionTable->Error_Create(
        &OScDevInternal_TheModuleImpl, message);
}

OScDev_API OScDev_RichError *
OScDev_Error_CreateWithCode(const char *domainName, int32_t code,
                            const char *message) {
    return OScDevInternal_FunctionTable->Error_CreateWithCode(
        &OScDevInternal_TheModuleImpl, domainName, code, message);
}

OScDev_API OScDev_RichError *OScDev_Error_Wrap(OScDev_RichError *cause,
                                               const char *message) {
    return OScDevInternal_FunctionTable->Error_Wrap(
        &OScDevInternal_TheModuleImpl, cause, message);
}

OScDev_API OScDev_RichError *OScDev_Error_WrapWithCode(OScDev_RichError *cause,
                                                       const char *domainName,
                                                       int32_t code,
                                                       const char *message) {
    return OScDevInternal_FunctionTable->Error_WrapWithCode(
        &OScDevInternal_TheModuleImpl, cause, domainName, code, message);
}

OScDev_API const char *OScDev_Error_GetMessage(OScDev_RichError *error) {
    return OScDevInternal_FunctionTable->Error_GetMessage(
        &OScDevInternal_TheModuleImpl, error);
}

OScDev_API const char *OScDev_Error_GetDomain(OScDev_RichError *error) {
    return OScDevInternal_FunctionTable->Error_GetDomain(
        &OScDevInternal_TheModuleImpl, error);
}

OScDev_API int32_t OScDev_Error_GetCode(OScDev_RichError *error) {
    return OScDevInternal_FunctionTable->Error_GetCode(
        &OScDevInternal_TheModuleImpl, error);
}

OScDev_API OScDev_RichError *OScDev_Error_GetCause(OScDev_RichError *error) {
    return OScDevInternal_FunctionTable->Error_GetCause(
        &OScDevInternal_TheModuleImpl, error);
}

OScDev_API void OScDev_Error_Format(OScDev_RichError *error, char *buffer,
                                    size_t bufsize) {
    OScDevInternal_FunctionTable->Error_Format(&OScDevInternal_TheModuleImpl,
                                               error, buffer, bufsize);
}

OScDev_API void OScDev_Error_FormatRecursive(OScDev_RichError *error,
                                             char *buffer, size_t bufsize) {
    OScDevInternal_FunctionTable->Error_FormatRecursive(
        &OScDevInternal_TheModuleImpl, error, buffer, bufsize);
}

OScDev_API OScDev_RichError *OScDev_Error_AsRichError(OScDev_Error code) {
    return OScDevInternal_FunctionTable->Error_AsRichError(
        &OScDevInternal_TheModuleImpl, code);
}

OScDev_API void OScDev_Error_Destroy(OScDev_RichError *error) {
    OScDevInternal_FunctionTable->Error_Destroy(&OScDevInternal_TheModuleImpl,
                                                error);
}

/// Create an array of objects.
OScDev_API OScDev_PtrArray *OScDev_PtrArray_Create(void) {
    return OScDevInternal_FunctionTable->PtrArray_Create(
        &OScDevInternal_TheModuleImpl);
}

OScDev_API OScDev_PtrArray *
OScDev_PtrArray_CreateFromNullTerminated(void *const *nullTerminatedArray) {
    return OScDevInternal_FunctionTable->PtrArray_CreateFromNullTerminated(
        &OScDevInternal_TheModuleImpl, nullTerminatedArray);
}

/// Destroy (free) an array of objects.
OScDev_API void OScDev_PtrArray_Destroy(const OScDev_PtrArray *arr) {
    OScDevInternal_FunctionTable->PtrArray_Destroy(
        &OScDevInternal_TheModuleImpl, arr);
}

/// Append an object to an array.
OScDev_API void OScDev_PtrArray_Append(OScDev_PtrArray *arr, void *obj) {
    OScDevInternal_FunctionTable->PtrArray_Append(
        &OScDevInternal_TheModuleImpl, arr, obj);
}

OScDev_API size_t OScDev_PtrArray_Size(const OScDev_PtrArray *arr) {
    return OScDevInternal_FunctionTable->PtrArray_Size(
        &OScDevInternal_TheModuleImpl, arr);
}

OScDev_API bool OScDev_PtrArray_Empty(const OScDev_PtrArray *arr) {
    return OScDevInternal_FunctionTable->PtrArray_Empty(
        &OScDevInternal_TheModuleImpl, arr);
}

OScDev_API void *OScDev_PtrArray_At(const OScDev_PtrArray *arr, size_t index) {
    return OScDevInternal_FunctionTable->PtrArray_At(
        &OScDevInternal_TheModuleImpl, arr, index);
}

/// Create an array of numbers.
OScDev_API OScDev_NumArray *OScDev_NumArray_Create(void) {
    return OScDevInternal_FunctionTable->NumArray_Create(
        &OScDevInternal_TheModuleImpl);
}

OScDev_API OScDev_NumArray *
OScDev_NumArray_CreateFromNaNTerminated(const double *nanTerminatedArray) {
    return OScDevInternal_FunctionTable->NumArray_CreateFromNaNTerminated(
        &OScDevInternal_TheModuleImpl, nanTerminatedArray);
}

/// Destroy (free) an array of numbers.
OScDev_API void OScDev_NumArray_Destroy(const OScDev_NumArray *arr) {
    OScDevInternal_FunctionTable->NumArray_Destroy(
        &OScDevInternal_TheModuleImpl, arr);
}

/// Append a value to an array.
OScDev_API void OScDev_NumArray_Append(OScDev_NumArray *arr, double val) {
    OScDevInternal_FunctionTable->NumArray_Append(
        &OScDevInternal_TheModuleImpl, arr, val);
}

OScDev_API size_t OScDev_NumArray_Size(const OScDev_NumArray *arr) {
    return OScDevInternal_FunctionTable->NumArray_Size(
        &OScDevInternal_TheModuleImpl, arr);
}

OScDev_API bool OScDev_NumArray_Empty(const OScDev_NumArray *arr) {
    return OScDevInternal_FunctionTable->NumArray_Empty(
        &OScDevInternal_TheModuleImpl, arr);
}

OScDev_API double OScDev_NumArray_At(const OScDev_NumArray *arr,
                                     size_t index) {
    return OScDevInternal_FunctionTable->NumArray_At(
        &OScDevInternal_TheModuleImpl, arr, index);
}

OScDev_API OScDev_NumRange *OScDev_NumRange_CreateContinuous(double rMin,
                                                             double rMax) {
    return OScDevInternal_FunctionTable->NumRange_CreateContinuous(
        &OScDevInternal_TheModuleImpl, rMin, rMax);
}

OScDev_API OScDev_NumRange *OScDev_NumRange_CreateDiscrete(void) {
    return OScDevInternal_FunctionTable->NumRange_CreateDiscrete(
        &OScDevInternal_TheModuleImpl);
}

OScDev_API OScDev_NumRange *OScDev_NumRange_CreateDiscreteFromNaNTerminated(
    const double *nanTerminatedArray) {
    return OScDevInternal_FunctionTable
        ->NumRange_CreateDiscreteFromNaNTerminated(
            &OScDevInternal_TheModuleImpl, nanTerminatedArray);
}

OScDev_API void OScDev_NumRange_Destroy(const OScDev_NumRange *range) {
    OScDevInternal_FunctionTable->NumRange_Destroy(
        &OScDevInternal_TheModuleImpl, range);
}

OScDev_API void OScDev_NumRange_AppendDiscrete(OScDev_NumRange *range,
                                               double value) {
    OScDevInternal_FunctionTable->NumRange_AppendDiscrete(
        &OScDevInternal_TheModuleImpl, range, value);
}

OScDev_API OScDev_Error OScDev_Device_Create(OScDev_Device **device,
                                             OScDev_DeviceImpl *impl,
                                             void *data) {
    return OScDevInternal_FunctionTable->Device_Create(
        &OScDevInternal_TheModuleImpl, device, impl, data);
}

OScDev_API void *OScDev_Device_GetImplData(OScDev_Device *device) {
    return OScDevInternal_FunctionTable->Device_GetImplData(
        &OScDevInternal_TheModuleImpl, device);
}

OScDev_API OScDev_Error OScDev_Setting_Create(OScDev_Setting **setting,
                                              const char *name,
                                              OScDev_ValueType valueType,
                                              OScDev_SettingImpl *impl,
                                              void *data) {
    return OScDevInternal_FunctionTable->Setting_Create(
        &OScDevInternal_TheModuleImpl, setting, name, valueType, impl, data);
}

OScDev_API void OScDev_Setting_Destroy(OScDev_Setting *setting) {
    OScDevInternal_FunctionTable->Setting_Destroy(
        &OScDevInternal_TheModuleImpl, setting);
}

OScDev_API void *OScDev_Setting_GetImplData(OScDev_Setting *setting) {
    return OScDevInternal_FunctionTable->Setting_GetImplData(
        &OScDevInternal_TheModuleImpl, setting);
}

/// Determine whether this device should provide the clock for the given
/// acquisition.
OScDev_API OScDev_Error OScDev_Acquisition_IsClockRequested(
    OScDev_Acquisition *acq, bool *isRequested) {
    return OScDevInternal_FunctionTable->Acquisition_IsClockRequested(
        &OScDevInternal_TheModuleImpl, acq, isRequested);
}

/// Determine whether this device should perform scanning for the given
/// acquisition.
OScDev_API OScDev_Error OScDev_Acquisition_IsScannerRequested(
    OScDev_Acquisition *acq, bool *isRequested) {
    return OScDevInternal_FunctionTable->Acquisition_IsScannerRequested(
        &OScDevInternal_TheModuleImpl, acq, isRequested);
}

/// Determine whether this device should perform detection for the given
/// acquisition.
OScDev_API OScDev_Error OScDev_Acquisition_IsDetectorRequested(
    OScDev_Acquisition *acq, bool *isRequested) {
    return OScDevInternal_FunctionTable->Acquisition_IsDetectorRequested(
        &OScDevInternal_TheModuleImpl, acq, isRequested);
}
 ...
 * \param[out] startTrigger the clock start trigger; either software or
 * external
 */
OScDev_API OScDev_Error OScDev_Acquisition_GetClockStartTriggerSource(
    OScDev_Acquisition *acq, OScDev_TriggerSource *startTrigger) {
    return OScDevInternal_FunctionTable
        ->Acquisition_GetClockStartTriggerSource(&OScDevInternal_TheModuleImpl,
                                                 acq, startTrigger);
}
 ...
 */
OScDev_API OScDev_Error OScDev_Acquisition_GetClockSource(
    OScDev_Acquisition *acq, OScDev_ClockSource *clock) {
    return OScDevInternal_FunctionTable->Acquisition_GetClockSource(
        &OScDevInternal_TheModuleImpl, acq, clock);
}

/// Determine the requested number of frames for the given acquisition.
OScDev_API uint32_t
OScDev_Acquisition_GetNumberOfFrames(OScDev_Acquisition *acq) {
    return OScDevInternal_FunctionTable->Acquisition_GetNumberOfFrames(
        &OScDevInternal_TheModuleImpl, acq);
}

OScDev_API double OScDev_Acquisition_GetPixelRate(OScDev_Acquisition *acq) {
    return OScDevInternal_FunctionTable->Acquisition_GetPixelRate(
        &OScDevInternal_TheModuleImpl, acq);
}

OScDev_API uint32_t OScDev_Acquisition_GetResolution(OScDev_Acquisition *acq) {
    return OScDevInternal_FunctionTable->Acquisition_GetResolution(
        &OScDevInternal_TheModuleImpl, acq);
}

OScDev_API double OScDev_Acquisition_GetZoomFactor(OScDev_Acquisition *acq) {
    return OScDevInternal_FunctionTable->Acquisition_GetZoomFactor(
        &OScDevInternal_TheModuleImpl, acq);
}
...
OScDev_API void OScDev_Acquisition_GetROI(OScDev_Acquisition *acq,
    ...
    OScDevInternal_FunctionTable->Acquisition_GetROI(
        &OScDevInternal_TheModuleImpl, acq, xOffset, yOffset, width, height);
}
...
OScDev_API bool OScDev_Acquisition_CallFrameCallback(OScDev_Acquisition *acq,
                                                     uint32_t channel,
                                                     void *pixels) {
    return OScDevInternal_FunctionTable->Acquisition_CallFrameCallback(
        &OScDevInternal_TheModuleImpl, acq, channel, pixels);
}
